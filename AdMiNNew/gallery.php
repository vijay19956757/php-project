          ...
          <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="addelecture.php"> Add Image </a>
              </div>
            </div>
          </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div class="container-fluid">
              ...
              <!-- index page content -->
              <div class="">
                <form class="form" action="electureconfirm.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="eimg">Gallery Image</label>
                    <input type="file" name="eimg" accept=".jpg" required />
                  </div>
                  <!-- <div class="form-group">
                    <label for="edesc">Lecture Description </label>
                    <textarea name="edesc" class="form-control" rows="5" cols="80" placeholder="About Lecture"></textarea> -->
